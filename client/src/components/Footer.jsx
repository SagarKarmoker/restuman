...
export default function Footer() {
    return (
        <div className='bg-base-200 px-5'>
            <footer className="container mx-auto footer text-base-content py-10">
                <aside>
                    ...
                    <p>
                    RestuMan<br />
                        Helping restaurants run smoothly since 2024
                    </p>
                </aside>
                ...
                <nav>
                    ...
                    <a className="link link-hover">Menu Customization</a>
